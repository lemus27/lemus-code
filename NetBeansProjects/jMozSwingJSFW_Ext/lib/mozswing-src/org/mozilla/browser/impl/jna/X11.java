...
public interface X11 extends Library {
    ...
    public static class XID implements NativeMapped {
        ...
        public boolean isNone(Object o) {
    ...
    public interface Xext extends Library {
        Xext INSTANCE = (Xext)Native.loadLibrary("Xext", Xext.class); //$NON-NLS-1$
        // Shape Kinds
        int ShapeBounding = 0;
        int ShapeClip = 1;
        int ShapeInput = 2;
    ...
    public interface Xrender extends Library {
        Xrender INSTANCE = (Xrender)Native.loadLibrary("Xrender", Xrender.class); //$NON-NLS-1$
    ...
    X11 INSTANCE = (X11)Native.loadLibrary("X11", X11.class); //$NON-NLS-1$
    ...
    public interface XErrorHandlerFunc extends Callback {
        //int callback(Display display, XErrorEvent error_event);
        int callback(Pointer display, Pointer error_event);
    }
    //XErrorHandlerFunc XSetErrorHandler(XErrorHandlerFunc handler);
    int XSetErrorHandler(XErrorHandlerFunc handler);

 ...
 */
public class Saf7AntibioticosView extends FrameView {
    
    public Saf7AntibioticosView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        saf7antibioticos.Antibioticos a = new saf7antibioticos.Antibioticos();
    ...
    public void deleteRecord() {
        ...
        List<saf7antibioticos.Antibioticos> toRemove = new ArrayList<saf7antibioticos.Antibioticos>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            saf7antibioticos.Antibioticos a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<saf7antibioticos.Antibioticos> merged = new ArrayList<saf7antibioticos.Antibioticos>(list.size());
                for (saf7antibioticos.Antibioticos a : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = Saf7AntibioticosApp.getApplication().getMainFrame();
            aboutBox = new Saf7AntibioticosAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        Saf7AntibioticosApp.getApplication().show(aboutBox);
    }
    //***********************************************
 ...
 Connection  conn =null;
    ...
    conn = DriverManager.getConnection("jdbc:derby:C:\\Antibioticos\\antb;create=true;user=app;password=app");
            ...
            Logger.getLogger(Saf7AntibioticosView.class.getName()).log(Level.SEVERE, null, ex);
  ...
  //La Ruta de nuestro reporte
   ...
   try
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(saf7antibioticos.Saf7AntibioticosApp.class).getContext().getResourceMap(Saf7AntibioticosView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(saf7antibioticos.Saf7AntibioticosApp.class).getContext().getActionMap(Saf7AntibioticosView.class, this);
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(idantibioticosField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(procedenciaField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(numerofacturaField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(loteField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(stockField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(nombreprescriptorField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(cedulaField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(domicilioField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(observacionesField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(cantadquiridaField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(cantdesechadaField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(fechacaducidadField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            .addComponent(fechaField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)))
    ...
    private java.util.List<saf7antibioticos.Antibioticos> list;

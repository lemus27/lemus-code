 ...
 */
public class Saf6AntibioticosView extends FrameView {
    
    public Saf6AntibioticosView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        saf6antibioticos.Antibioticos a = new saf6antibioticos.Antibioticos();
    ...
    public void deleteRecord() {
        ...
        List<saf6antibioticos.Antibioticos> toRemove = new ArrayList<saf6antibioticos.Antibioticos>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            saf6antibioticos.Antibioticos a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<saf6antibioticos.Antibioticos> merged = new ArrayList<saf6antibioticos.Antibioticos>(list.size());
                for (saf6antibioticos.Antibioticos a : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = Saf6AntibioticosApp.getApplication().getMainFrame();
            aboutBox = new Saf6AntibioticosAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        Saf6AntibioticosApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(saf6antibioticos.Saf6AntibioticosApp.class).getContext().getResourceMap(Saf6AntibioticosView.class);
        ...
        masterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Procedencia", "Numerode factura", "Lote", "Fecha de caducidad", "Cant. adquirida", "Cant. desechada", "Queda", "Nombre Del prescriptor", "Cedula profesional", "Domicilio", "Observaciones"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Long.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class
            };
        ...
        columnBinding.setColumnName("Numerofactura");
        ...
        numerofacturaLabel.setText(resourceMap.getString("numerofacturaLabel.text")); // NOI18N
        numerofacturaLabel.setName("numerofacturaLabel"); // NOI18N
        ...
        numerofacturaField.setName("numerofacturaField"); // NOI18N
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(saf6antibioticos.Saf6AntibioticosApp.class).getContext().getActionMap(Saf6AntibioticosView.class, this);
        ...
        jButton2.setAction(actionMap.get("imprimirReporte")); // NOI18N
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(idantibioticosField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(procedenciaField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(numerofacturaField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(loteField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(fechacaducidadField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(cantadquiridaField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(cantdesechadaField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(stockField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(nombreprescriptorField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(cedulaField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(domicilioField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)
                            .addComponent(observacionesField, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE)))
    ...
    private java.util.List<saf6antibioticos.Antibioticos> list;

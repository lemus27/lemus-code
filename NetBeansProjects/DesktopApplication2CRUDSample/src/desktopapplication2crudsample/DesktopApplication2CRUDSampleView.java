/*
 * DesktopApplication2CRUDSampleView.java
 */
 ...
 */
public class DesktopApplication2CRUDSampleView extends FrameView {
    
    public DesktopApplication2CRUDSampleView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        desktopapplication2crudsample.Customer c = new desktopapplication2crudsample.Customer();
    ...
    public void deleteRecord() {
        ...
        List<desktopapplication2crudsample.Customer> toRemove = new ArrayList<desktopapplication2crudsample.Customer>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            desktopapplication2crudsample.Customer c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<desktopapplication2crudsample.Customer> merged = new ArrayList<desktopapplication2crudsample.Customer>(list.size());
                for (desktopapplication2crudsample.Customer c : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DesktopApplication2CRUDSample.getApplication().getMainFrame();
            aboutBox = new DesktopApplication2CRUDSampleAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DesktopApplication2CRUDSample.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(desktopapplication2crudsample.DesktopApplication2CRUDSample.class).getContext().getResourceMap(DesktopApplication2CRUDSampleView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(desktopapplication2crudsample.DesktopApplication2CRUDSample.class).getContext().getActionMap(DesktopApplication2CRUDSampleView.class, this);
    ...
    private java.util.List<desktopapplication2crudsample.Customer> list;

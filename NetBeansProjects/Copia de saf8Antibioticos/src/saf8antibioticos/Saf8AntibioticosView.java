/*
 * Saf8AntibioticosView.java
 */

package saf8antibioticos;
//*****************************************
import java.sql.*;
import java.util.*;
 ...
 */
public class Saf8AntibioticosView extends FrameView {
    
    public Saf8AntibioticosView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        saf8antibioticos.Antibioticos a = new saf8antibioticos.Antibioticos();
    ...
    public void deleteRecord() {
        ...
        List<saf8antibioticos.Antibioticos> toRemove = new ArrayList<saf8antibioticos.Antibioticos>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            saf8antibioticos.Antibioticos a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<saf8antibioticos.Antibioticos> merged = new ArrayList<saf8antibioticos.Antibioticos>(list.size());
                for (saf8antibioticos.Antibioticos a : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = Saf8AntibioticosApp.getApplication().getMainFrame();
            aboutBox = new Saf8AntibioticosAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        Saf8AntibioticosApp.getApplication().show(aboutBox);
    }
//*******************************************************************************
 ...
 Connection  conn =null;
    ...
    conn = DriverManager.getConnection("jdbc:derby:C:\\Antibioticos\\antb;create=true;user=app;password=app");
            ...
            Logger.getLogger(Saf8AntibioticosView.class.getName()).log(Level.SEVERE, null, ex);
...
//************************************************************************************
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(saf8antibioticos.Saf8AntibioticosApp.class).getContext().getResourceMap(Saf8AntibioticosView.class);
        ...
        masterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Fecha", "Nombre", "Procedencia", "Num. de factura", "Lote", "Fecha de caducidad", "Cant. Adquirida", "Cant. Desechada", "Queda", "Nombre del prescriptor", "Cedula", "Domicilio", "Observaciones"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Long.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class
            };
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(saf8antibioticos.Saf8AntibioticosApp.class).getContext().getActionMap(Saf8AntibioticosView.class, this);
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(idantibioticosField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(procedenciaField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(numfacturaField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(loteField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(fechacaducidadField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(fechaField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(cantadquiridaField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(cantdesechadaField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(stockField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(nombreprescriptorField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(cedulaField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(domicilioField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(nombreField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)
                            .addComponent(observacionesField, javax.swing.GroupLayout.DEFAULT_SIZE, 495, Short.MAX_VALUE)))
        ...
        statusPanelLayout.setHorizontalGroup(
            ...
            .addComponent(statusPanelSeparator, javax.swing.GroupLayout.DEFAULT_SIZE, 632, Short.MAX_VALUE)
    ...
    private java.util.List<saf8antibioticos.Antibioticos> list;

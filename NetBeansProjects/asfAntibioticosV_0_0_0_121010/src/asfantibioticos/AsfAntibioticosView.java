 ...
 */
public class AsfAntibioticosView extends FrameView {
    
    public AsfAntibioticosView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        asfantibioticos.Antibioticos a = new asfantibioticos.Antibioticos();
    ...
    public void deleteRecord() {
        ...
        List<asfantibioticos.Antibioticos> toRemove = new ArrayList<asfantibioticos.Antibioticos>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            asfantibioticos.Antibioticos a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<asfantibioticos.Antibioticos> merged = new ArrayList<asfantibioticos.Antibioticos>(list.size());
                for (asfantibioticos.Antibioticos a : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = AsfAntibioticosApp.getApplication().getMainFrame();
            aboutBox = new AsfAntibioticosAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        AsfAntibioticosApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(asfantibioticos.AsfAntibioticosApp.class).getContext().getResourceMap(AsfAntibioticosView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(asfantibioticos.AsfAntibioticosApp.class).getContext().getActionMap(AsfAntibioticosView.class, this);
    ...
    private java.util.List<asfantibioticos.Antibioticos> list;

...
public class DesktopApplication2View extends FrameView {
    ...
    public void newRecord() {
        desktopapplication2.Antibioticos a = new desktopapplication2.Antibioticos();
    ...
    public void deleteRecord() {
        ...
        List<desktopapplication2.Antibioticos> toRemove = new ArrayList<desktopapplication2.Antibioticos>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            desktopapplication2.Antibioticos a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<desktopapplication2.Antibioticos> merged = new ArrayList<desktopapplication2.Antibioticos>(list.size());
                for (desktopapplication2.Antibioticos a : list) {
    ...
    private java.util.List<desktopapplication2.Antibioticos> list;

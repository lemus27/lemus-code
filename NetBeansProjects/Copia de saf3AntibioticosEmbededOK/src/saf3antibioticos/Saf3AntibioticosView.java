 ...
 */
public class Saf3AntibioticosView extends FrameView {
    
    public Saf3AntibioticosView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        saf3antibioticos.Antibioticos a = new saf3antibioticos.Antibioticos();
    ...
    public void deleteRecord() {
        ...
        List<saf3antibioticos.Antibioticos> toRemove = new ArrayList<saf3antibioticos.Antibioticos>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            saf3antibioticos.Antibioticos a = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(a);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<saf3antibioticos.Antibioticos> merged = new ArrayList<saf3antibioticos.Antibioticos>(list.size());
                for (saf3antibioticos.Antibioticos a : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = Saf3AntibioticosApp.getApplication().getMainFrame();
            aboutBox = new Saf3AntibioticosAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        Saf3AntibioticosApp.getApplication().show(aboutBox);
    }
public static Connection getConnection()  {
 ...
 Connection  conn =null;
    ...
    conn = DriverManager.getConnection("jdbc:derby:C:\\Antibioticos\\antb;create=true;user=app;password=app");
            ...
            Logger.getLogger(Saf3AntibioticosView.class.getName()).log(Level.SEVERE, null, ex);
  ...
  //La Ruta de nuestro reporte
   ...
   try
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(saf3antibioticos.Saf3AntibioticosApp.class).getContext().getResourceMap(Saf3AntibioticosView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(saf3antibioticos.Saf3AntibioticosApp.class).getContext().getActionMap(Saf3AntibioticosView.class, this);
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(numfacturaField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                            ...
                            .addComponent(nombreField, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)))
    ...
    private class ReportearTask extends org.jdesktop.application.Task<Object, Void> {
        ReportearTask(org.jdesktop.application.Application app) {
            // Runs on the EDT.  Copy GUI state that
            // doInBackground() depends on from parameters
            // to ReportearTask fields, here.
            super(app);
        }
    ...
    private java.util.List<saf3antibioticos.Antibioticos> list;

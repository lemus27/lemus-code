...
DemoApp = Core.extend(Echo.Application, {
    ...
    $static: {/*miembros staticos de la clase DemoApp*/
         ...
         */ 
        pref: {/*miembro estaticos de la clase DemoApp*/
...
/*fin de los  miembros  estaticos de la  clase  demoapp*/
    ...
    init: function() {/*miembro no estatico de de la clase DemoApp*/
       ...
       var sections = [
            new DemoApp.Workspace.SectionData(
            	this._msg["SectionTitle.Welcome"], [
...
/*fin de la  clse  DemoApp.DownloadWindow*/
/**
...
DemoApp.Workspace = Core.extend(Echo.ContentPane, {
    ...
    $static: {/*nicio de los miembro staticos de la clase DemoApp.workSpace*/
        ...
        SectionData: Core.extend({/*miembro staticos de la clase DemoApp.workSpace*/
             ...
             * @param {screens} array of DemoApp.WorkSpace.ScreenData objects contained in the section
             */
         ...
         */
        ScreenData: Core.extend({/*miembro staticos de la clase DemoApp.workSpace*/
             ...
             */
             /*metodo constructor de la  clase screenData */
...
/*fin de los miembro staticos de la clase DemoApp.workSpace*/
     ...
     */
    _launchPanel: null,/*miembro privado de la clase DemoApp.workSpace*/
    
    /**
     * The main content area used to display demonstration screens.
     * @type Extras.TransitionPane
     */
    _contentArea: null,/*miembro privado de la clase DemoApp.workSpace*/
     ...
     */
    _screenMap: null,/*miembro privado de la clase DemoApp.workSpace*/
    
    /**
     * The currently displayed screen.
     * @type DemoApp.Workspace.ScreenData
     */
    _activeScreen: null,/*miembro privado de la clase DemoApp.workSpace*/
    
    /**
     * Array of DemoApp.Workspace.SectionData instances which are available.
     * @type Array
     */
    _sections: null,/*miembro privado de la clase DemoApp.workSpace*/
    
    /**
     * Launch button for currently active screen.
     * @type Echo.Button
     */
    _activeScreenLaunchButton: null,/*miembro privado de la clase DemoApp.workSpace*/
    
    /**
     * Window displaying stop controls, displayed when automatic demo/performance test is active.
     * @type Echo.WindowPane
     */
    _stopWindow: null,/*miembro privado de la clase DemoApp.workSpace*/
    
    /**
     * Label displaying current frames-per-second, used when performance test is active.
     * @type Echo.Label
     */
    fpsLabel: null,/*miembro  de la clase DemoApp.workSpace*/
        ...
        Echo.ContentPane.call(this, {/*crando una clase derivad  si usar  core.extend*/
            children: [/*agregando  elemntos  al content panel*/
                new Echo.SplitPane({/*agregando un separador en el panel*/
                    ...
                    children: [/*agrenado un separador  al separador  anterior*/
                        new Echo.SplitPane({
                            ...
                            children: [/*agregando una  etiqureta al anteriror separador*/
                                new Echo.Label({
                                ...
                                /*agregando  aun panel acordeon al 2 separador*/
     ...
     */
    _createLaunchPanel: function() {/*metodo privado de la  clase DemoApp.workspace */
        this._screenMap = { };
     ...
     */
    createMenuModel: function() {/*metodo  de la  clase DemoApp.workspace */
     ...
     * @type DemoApp.Workspace.ScreenData
     */
    getNextScreen: function() {/*metodo  de la  clase DemoApp.workspace */
     ...
     * @type DemoApp.Workspace.ScreenData
     */
    getPreviousScreen: function() {/*metodo privado de la  clase DemoApp.workspace */
        var activeFound = this._activeScreen == null;
        for (var k = 0; k < 2; ++k) {
     ...
     */
    launchScreen: function(screen, windowed) {/*metodo  de la  clase DemoApp.workspace */
        var screenWindow;
     ...
     */
    _processLauncherClick: function(e) {/*metodo privado de la  clase DemoApp.workspace */
     ...
     * @param e the event
     */
    _processMenuAction: function(e) {/*metodo privado de la  clase DemoApp.workspace */
        switch (e.modelId) {
        case "about":
     ...
     */
    _setActiveTab: function(screen) {/*metodo privado de la  clase DemoApp.workspace */
     ...
     * @param {Echo.Component} content the component to display
     */
    setContent: function(content) {/*metodo  de la  clase DemoApp.workspace */
     ...
     */
    _setLocale: function(locale) {/*metodo privado de la  clase DemoApp.workspace */
     ...
     */
    setTransition: function(type, overridePreferences) {/*metodo  de la  clase DemoApp.workspace */
     ...
     */
    startAutomaticDemo: function(performanceTest, interval, randomOrder, transitionStyle) {/*metodo  de la  clase DemoApp.workspace */
        if (performanceTest) {
            interval = 0;
     ...
     */
    stopAutomaticDemo: function(performanceTestFps) {/*metodo  de la  clase DemoApp.workspace */

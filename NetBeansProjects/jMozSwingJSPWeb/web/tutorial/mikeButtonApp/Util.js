 ...
 */
mikeButtonApp.ColorSelectButton = Core.extend(Echo.Button, {
 ...
 */
mikeButtonApp.HtmlLabel = Core.extend(Echo.Component, {
 ...
 */
mikeButtonApp.HtmlLabelSync = Core.extend(Echo.Render.ComponentSync, {

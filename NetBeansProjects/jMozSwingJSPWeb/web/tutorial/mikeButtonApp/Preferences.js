 ...
 */
mikeButtonApp.PreferencesDialog = Core.extend(Echo.WindowPane, {
    ...
    $construct: function() {
        ...
        Echo.WindowPane.call(this, {
            styleName: mikeButtonApp.pref.windowStyleName,
            modal: true,
            width: "40em",
                                        ...
                                        new Echo.Row({
                                            ...
                                            children: [
                                                this._transitionsEnabled = new Echo.RadioButton({
                                                    ...
                                                    selected: mikeButtonApp.pref.transitionsEnabled
                                                }),
                                ...
                                new Echo.Column({
                                    ...
                                    children: [
                                        ...
                                        this._windowStyleNameSelect = new Echo.SelectField({
                                            ...
                                            selectedId: mikeButtonApp.pref.windowStyleName == null ? "None" : mikeButtonApp.pref.windowStyleName
                                        })
                                    ]
                                }),
                                new Echo.Column({
                                            ...
                                            children: [
                                                new Echo.Row({
                                                    ...
                                                    children: [
                                                        ...
                                                        this._sourceViewerForeground = new mikeButtonApp.ColorSelectButton(
                                                                mikeButtonApp.pref.sourceViewerForeground)
                                                    ]
                                                }),
                                                new Echo.Row({
                                                    cellSpacing: 10,
                                                    children: [
                                                        ...
                                                        this._sourceViewerBackground = new mikeButtonApp.ColorSelectButton(
                                                                mikeButtonApp.pref.sourceViewerBackground)
                                                    ]
                                                })
                                            ]
                                        })
    ...
    _apply: function(e) {
        mikeButtonApp.pref.windowStyleName = this._windowStyleNameSelect.get("selectedId") == "None" ?
                null : this._windowStyleNameSelect.get("selectedId");
        mikeButtonApp.pref.transitionsEnabled = this._transitionsEnabled.get("selected");
        mikeButtonApp.pref.sourceViewerBackground = this._sourceViewerBackground.color;
        mikeButtonApp.pref.sourceViewerForeground = this._sourceViewerForeground.color;
